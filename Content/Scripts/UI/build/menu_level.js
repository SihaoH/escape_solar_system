...
class MenuLevel extends React.Component {
    constructor(props) {
        ...
        this.shipLevel = [{
            ...
            tag: "引擎",
            btn: [level_btn("化学引擎", "化学引擎", [ELevel.ShipEngine0Power, ELevel.ShipEngine0Mass, ELevel.ShipEngine0EPR, ELevel.ShipEngine0EMR]), level_btn("核裂变引擎", "采用核裂变产生的能量作为推力，是较为成熟的核动力引擎方案", [ELevel.ShipEngine1Power, ELevel.ShipEngine1Mass, ELevel.ShipEngine1EPR, ELevel.ShipEngine1EMR]), level_btn("核聚变引擎", "内置了小型化的托卡马克设备，使用可控核聚变作为动力，少量的聚变燃料即可转换为极大的动能", [ELevel.ShipEngine2Power, ELevel.ShipEngine2Mass, ELevel.ShipEngine2EPR, ELevel.ShipEngine2EMR])]
        }, {
            tag: "燃料仓",
            btn: [level_btn("化学燃料仓", "化学燃料", [ELevel.ShipEnergy0]), level_btn("核裂变燃料仓", "高纯度铀", [ELevel.ShipEnergy1]), level_btn("核聚变燃料仓", "氦-3", [ELevel.ShipEnergy2])]
        }];
        this.state = {
            charInfo: [],
            shipInfo: []
