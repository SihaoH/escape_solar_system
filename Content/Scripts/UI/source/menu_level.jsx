    ...
    render() {
        return (
            <div
                {...this.props}
            >
                {_.map(this.props.levelList, (val) => (
                <span
                    Slot={{ Padding: Utils.ltrb(0, 5) }}
                >
                    <uSizeBox
...
class MenuLevel extends React.Component {
        ...
        this.charLevel = [
            {
                tag: "机身",
                btn: [
                    level_btn("机身强度", "机身强度可以提升血量，但同时也会增加机体的质量", [ELevel.CharHP, ELevel.CharMass]),
                    level_btn("装载", "升级可以提升背包的载重，注意：背包的物品会叠加到总体质量上", [ELevel.CharBackpack]),
                ]
            },
            {
                tag: "护盾",
                btn: [
                    level_btn("冷防护", "冷防护", [ELevel.CharShieldCold]),
                    level_btn("热防护", "热防护", [ELevel.CharShieldHeat]),
                    level_btn("压力防护", "压力防护", [ELevel.CharShieldPress]),
                ]
            },
            {
                tag: "引擎",
                btn: [
                    level_btn("普通引擎", "采用常规化学燃料推进的引擎", [ELevel.CharEnginePower, ELevel.CharEngineMass, ELevel.CharEngineEPR, ELevel.CharEngineEMR]),
                ]
            },
            {
                tag: "燃料仓",
                btn: [
                    level_btn("化学燃料仓", "就是化学燃料仓", [ELevel.CharEnergy]),
                ]
            },
        ]
        this.shipLevel = [
            {
                tag: "机身",
                btn: [
                    level_btn("机身强度", "机身强度可以提升血量，但同时也会增加机体的质量", [ELevel.ShipHP, ELevel.ShipMass]),
                    level_btn("装载", "升级可以提升背包的载重，注意：背包的物品会叠加到总体质量上", [ELevel.ShipBackpack]),
                ]
            },
            {
                tag: "护盾",
                btn: [
                    level_btn("冷防护", "冷防护", [ELevel.ShipShieldCold]),
                    level_btn("热防护", "热防护", [ELevel.ShipShieldHeat]),
                    level_btn("压力防护", "压力防护", [ELevel.ShipShieldPress]),
                ]
            },
            {
                tag: "引擎",
    ...
    updateInfo() {
        ...
        this.setState({
            charInfo: [
                info_row("HP", `${char.Body.CurrentHP}/${char.Body.MaximumHP}`),
                ...
                info_row("燃料能量", `${char.Engine.CurrentEnergy}/${char.Engine.MaximumEnergy}`),
        ...
        if (ship) {
            this.setState({
                shipInfo: [
                    info_row("HP", `${ship.Body.CurrentHP}/${ship.Body.MaximumHP}`),
